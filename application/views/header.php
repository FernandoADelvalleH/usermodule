...
<body>
	...
	<?php
		if ($this->session->userdata('is_logged_in')){
			...
			echo '<hr/>';
			echo '<p align="right">';
			echo '<table class="table table-striped" align="right">';
			echo '<tr>';
			foreach($this->session->userdata('Permisos') as $CrearMenu1){
                            ...
                            if($CrearMenu1["ID"]=="Error"){
                                echo '<td><font color="red">Sin Permisos para el Ver Menu. Solicita los Permisos con un Administrador</font></td>';
                                  ...
                                  echo '<td><a class="btn btn-info col-10" href="'.base_url().'index.php'.$CrearMenu1["URL"].'">'.$CrearMenu1["DESCRIPCION"]."</a></td>";
                                  echo '<td>&nbsp;|&nbsp;</td>';
                            }
			}
            echo '</tr>';

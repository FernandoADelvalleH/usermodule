...
?>
<table width='450' border='0' class='table table-striped' cellspacing='0' cellpadding='0'>
<tr>
     <td colspan='3' class='' height='10' colspan='3'><legend align="center">::: LOGIN ::: </legend></td>
...
<td colspan="3" align ='center'>
        ...
        <!--input id="btn_cancel" name="btn_cancel" type="reset" class="btn btn-info" value="Limpiar"-->
</td>
</tr>
<tr>
     <td colspan="3" align ='center'>

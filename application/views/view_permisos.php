<?php
	  ...
	  echo '<tr>';
	  echo "<td class='' height='10' colspan='3'><legend align='center'>.: Asignar Permisos a ".$datos_usuarios[0]->NOMBRE.' '.$datos_usuarios[0]->APELLIDOS." :.</legend></td>";
	  echo '</tr>';
	  echo '<tr><td colspan=3>';
	  echo form_open();
	  echo '<center>';
	  echo '<div id="container">';
	  echo '<table class="table table-striped" border=0 class="pretty">';

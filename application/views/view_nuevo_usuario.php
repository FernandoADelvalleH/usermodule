<?php
	  ...
	  echo '<tr>';
	  echo "<td height='10' class='thead-default' height='10' colspan='3'><legend align='center'>.: Usuario :.</legend></td>";
	  echo '</tr>';
	...
	'id'          => 'SNETWORKS',
	'size'        => 50,
	'value'		  => set_value('SNETWORKS',@$datos_usuarios[0]->SNETWORKS),
	'placeholder' => 'Red social',
	'type'        => 'text',
	'class'		  => 'form-control',
	);
	echo '<tr>';
	echo '<td>'.form_label("Red social:",'SNETWORKS').'</td>';
	echo '<td>';
	echo form_input($Snetworks);
	echo '</td>';
	echo '<td><font color="red">'.form_error('SNETWORKS').'</font></td>';
	echo '</tr>';
